  ...
  return (
    <div>
      <header>
        ...
        <address><i> by Kate Farley <a href="kate.farley@nytimes.com">(kate.farley@nytimes.com)</a></i></address>
        <time dateTime="2018-11-22">November 22, 2018</time> 
        <p>The Statue of Liberty's original torch is getting a new home.</p>
        <p>
          Made of copper and gold so that it would shine bright, the first torch took a beating from the weather and was replaced by a replica in 
          <time dateTime="1984"> 1984</time>
          . It's been stored in the statue's pedestal ever since.
        </p>
        <p>
          But visitors will be able to see the original 3,600-pound torch in all its glory at a new Statue of Liberty Museum, which will open on Liberty Island in
          <time dateTime="2019-05"> May 2019</time>
          . The torch was transported there by truck last week, along with a replica model of Lady Liberty's face.
        </p> 
        <p>
          <q>
            &nbsp;Although it is not one of the most difficult things we have ever moved,&nbsp;
          </q> 
          &nbsp;says Douglas Phelps, who oversaw the relocation of the torch,&nbsp; 
          <q>it is certainly the most important.</q>
        </p> 
      </header>
      <section>
